 ...
 * http(s)://APP/?controller=subtypes&action=read
 * http(s)://APP/?controller=subtypes&action=read&id=1
 * http(s)://APP/?controller=subtypes&action=create&name=hum0&type=1&threshold=100&protocol=1
 * http(s)://APP/?controller=subtypes&action=read&id=2
 * http(s)://APP/?controller=subtypes&action=delete&id=2

...
//				$register = array( 1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384 ); 
...
//						if( i <= 7 ) $( this ).prop( 'checked', false );
						if( i <= 7 ) $( '#' + this.id ).bootstrapSwitch('state', false);
					});
				}
				if( id == '#rel_all' ) {
					$('input:checkbox').each(function( i,input ){
...
//						if( i <= 7 ) $( this ).prop( 'checked', true );
						if( i <= 7 ) $( '#' + this.id ).bootstrapSwitch('state', true);
					});
				}
